...
El proyecto, para funcionar, necesita definir las siguientes variables:

```properties
MASTER_KEY=unaClaveAleatoriaYSuficientementeLarga
JWT_SECRET=otroSecretoAleatorioYTambiénSuficientementeLargo
MONGODB_URI=cadenaDeConexionALaBaseDeDatos
```

La definición de variables se puede realizar en un fichero `.env`
